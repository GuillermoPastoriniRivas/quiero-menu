...
export type UpdateRestaurantRequestDto = z.infer<
...
export type UpdateOperatingHoursRequestDto = z.infer<
  typeof UpdateOperatingHoursRequestSchema
>;

export const UpdateOpenStatusRequestSchema = z.object({
  open: z.boolean({
    error: 'open debe ser un booleano.',
  }),
});
export type UpdateOpenStatusRequestDto = z.infer<
  typeof UpdateOpenStatusRequestSchema
>;
