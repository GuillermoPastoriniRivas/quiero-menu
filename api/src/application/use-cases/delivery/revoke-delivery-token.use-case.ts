...
import { DeliveryTokenInvalidError, CrossRestaurantAccessError } from '../../../domain/errors/domain-errors.js';

export class RevokeDeliveryTokenUseCase {
  constructor(private readonly tokenRepo: DeliveryAccessTokenRepository) {}

  async execute(id: string, restaurantId: string): Promise<Result<DeliveryAccessToken, DeliveryTokenInvalidError | CrossRestaurantAccessError>> {
